...
nnoremap  :tabnext
nnoremap  :NERDTree
nnoremap  :if (hlstate%2 == 0) | nohlsearch | else | set hlsearch | endif | let hlstate=hlstate+1
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/bundle/auto-pairs,~/.vim/bundle/lightline.vim,~/.vim/bundle/nerdcommenter,~/.vim/bundle/nerdtree,~/.vim/bundle/nerdtree-git-plugin,~/.vim/bundle/onedark.vim,~/.vim/bundle/twodark.vim,~/.vim/bundle/vim-gitgutter,~/.vim/bundle/vim-startify,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set smartcase
set smartindent
set softtabstop=2
